const main = ( (document) => {
  ...
  function bindEvents(todoItem) {
    ...
    editButton.addEventListener('click', editTodoItem, false);
    deleteButton.addEventListener('click', deleteTodoItem, false);
  }
  ...
  function main() {
    todoForm.addEventListener('submit', addTodoItem, false);
